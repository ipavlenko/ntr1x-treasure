...
CREATE TABLE accounts (ResourceId BIGINT NOT NULL, Name VARCHAR(255), Pwdhash VARCHAR(255), Random VARCHAR(255), PRIMARY KEY (ResourceId))
...
CREATE TABLE grants (Id BIGINT AUTO_INCREMENT NOT NULL, Action VARCHAR(255), Pattern VARCHAR(255), AccountId BIGINT NOT NULL, PRIMARY KEY (Id))
...
CREATE TABLE resources_categories (Id BIGINT AUTO_INCREMENT NOT NULL, CategoryId BIGINT NOT NULL, RelateId BIGINT NOT NULL, PRIMARY KEY (Id))
CREATE TABLE tags (Id BIGINT AUTO_INCREMENT NOT NULL, Value VARCHAR(255), RelateId BIGINT NOT NULL, PRIMARY KEY (Id))
...
ALTER TABLE grants ADD CONSTRAINT FK_grants_AccountId FOREIGN KEY (AccountId) REFERENCES resources (Id)
