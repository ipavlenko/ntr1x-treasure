...
//
//import com.ntr1x.treasure.web.filters.UserElementFilter.SecurityUserPrincipal;
//
//import lombok.Data;
//
//@Provider
...
//					String action = name.substring(pos + 1);        // действие, которое планируется выполнить (имя гранта (просто троковая репрезентация))
//
//                    // смотрим, есть ли пользователь, у котор в таблице грантов есть указанный action на указанный resource:
//					int count = em.createNamedQuery("SecurityPrivilege.check", Integer.class)
//							.setParameter("action", action)
//							.setParameter("resource", resource)
//							.setParameter("user", userPrincipal.session.getUser().getId())
//							.getSingleResult();
//					
//					return count > 0;
//				}
