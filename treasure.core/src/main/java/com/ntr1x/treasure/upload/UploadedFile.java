//package com.ntr1x.treasure.web.upload;
...
//
//    private final static Integer UPLOAD_ERR_OK = 0;
//
//    /**
...
//        this.size = size;
//        this.error = (error == null || error == 0 ? null : UPLOAD_ERR_OK);
//        this.test = test;
//    }
//
//    /**
...
//    {
//        boolean isOk = this.error == UPLOAD_ERR_OK;
//
...
//     */
//    public File move(String directory, String name) throws Exception {
//        if (this.isValid()) {
//            if (this.test) {
//                return parent::move($directory, $name);
//            }
//
//            File target = $this->getTargetFile(directory, name);
//
